...
pub struct EtomoLogCompleteIconBoundary {
    pub image: EtomoLogScaledImage,
    pub selected_image: Option<EtomoLogScaledImage>,
    pub pressed_image: Option<EtomoLogScaledImage>,
    pub rollover_image: Option<EtomoLogScaledImage>,
...
pub struct ButtonStyleExtensionBoundary {
    pub text_gap: bool,
    pub icon: EtomoLogCompleteIconBoundary,
    ...
    fn new(image_observer: Option<Arc<dyn ImageObserverBoundary>>) -> Self {
        Self {
            button_style_extension: ButtonStyleExtensionBoundary {
                text_gap: false,
                icon: EtomoLogCompleteIconBoundary {
...
mod tests {
    ...
    fn constructor_preserves_the_complete_icon_argument_order() {
        ...
        assert_eq!(style.icon.image, EtomoLogScaledImage::EtomoLog);
