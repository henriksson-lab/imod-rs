...
pub unsafe fn ixml_load_string(
    string: &[u8],
    with_xml_decl: i32,
    root_element: &mut Option<Vec<u8>>,
) -> i32 {
...
pub unsafe fn ixml_new_node_list(root_element: &[u8]) -> i32 {
...
pub unsafe fn ixml_write_file(xml_ind: i32, filename: &[u8]) -> i32 {
    let mut err = 0;
...
pub unsafe fn ixml_find_elements(
    xml_ind: i32,
    node_ind: i32,
    tag: &[u8],
    found_ind: *mut i32,
...
pub unsafe fn ixml_get_string_value(xml_ind: i32, node_ind: i32, string: &mut Vec<u8>) -> i32 {
...
pub unsafe fn ixml_get_integer_value(xml_ind: i32, node_ind: i32, val: *mut i32) -> i32 {
...
pub unsafe fn ixml_get_float_value(xml_ind: i32, node_ind: i32, val: *mut f32) -> i32 {
    let mut string: Vec<u8> = Vec::new();
    let mut num = 1;
    let err = get_element_string(xml_ind, node_ind, &mut string);
    if err != 0 {
...
pub unsafe fn ixml_get_double_value(xml_ind: i32, node_ind: i32, val: *mut f64) -> i32 {
    let mut string: Vec<u8> = Vec::new();
    let mut num = 1;
    let err = get_element_string(xml_ind, node_ind, &mut string);
    if err != 0 {
...
pub unsafe fn ixml_get_string_attribute(
    xml_ind: i32,
    node_ind: i32,
    name: &[u8],
    string: &mut Vec<u8>,
...
pub unsafe fn ixml_get_integer_attribute(
    xml_ind: i32,
    node_ind: i32,
    name: &[u8],
    val: *mut i32,
...
pub unsafe fn ixml_add_element(xml_ind: i32, node_ind: i32, tag: &[u8]) -> i32 {
    let mut err = 0;
    let node = get_node_at_index(xml_ind, node_ind, &mut err);
    if node.is_none() {
        return err;
...
pub unsafe fn ixml_set_string_value(xml_ind: i32, node_ind: i32, string: &[u8]) -> i32 {
    let mut err = 0;
    let node = get_node_at_index(xml_ind, node_ind, &mut err);
    if node.is_none() {
        return err;
...
pub unsafe fn ixml_set_integer_value(xml_ind: i32, node_ind: i32, val: i32) -> i32 {
...
pub unsafe fn ixml_set_float_value(xml_ind: i32, node_ind: i32, val: f32) -> i32 {
    let buffer = c_format_bytes("%g", &[CArg::Dbl(val as f64)]);
    ixml_set_string_value(xml_ind, node_ind, &buffer)
}

/// Matches C `ixmlSetDoubleValue`.
pub unsafe fn ixml_set_double_value(xml_ind: i32, node_ind: i32, val: f64) -> i32 {
    let buffer = c_format_bytes("%g", &[CArg::Dbl(val)]);
    ixml_set_string_value(xml_ind, node_ind, &buffer)
}

/// Matches C `ixmlAddStringAttribute`.
pub unsafe fn ixml_add_string_attribute(
    xml_ind: i32,
    node_ind: i32,
    name: &[u8],
    value: Option<&[u8]>,
...
pub unsafe fn ixml_add_integer_attribute(
    xml_ind: i32,
    node_ind: i32,
    name: &[u8],
    value: i32,
